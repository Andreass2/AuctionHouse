 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://soap.service/", wsdlLocation = "http://localhost:8080/SoapService/SoapService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://soap.service/", "SoapService");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://soap.service/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.service/", "SoapServicePort"), SoapService.class, features);
    }
